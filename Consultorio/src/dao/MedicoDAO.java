...
public class MedicoDAO {
    ...
    // Listar um médico pelo CRM
    public Medico informacoesMedico(String crm) throws SQLException, MedicoNaoEncontradoException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    throw new MedicoNaoEncontradoException("O CRM: " + crm + ", não pertence a nenhum médico cadastrado!");
                }
            }
        } 
    }
